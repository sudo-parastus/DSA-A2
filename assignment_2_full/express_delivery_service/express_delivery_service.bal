...
public function main() returns error? {
    ...
    while true {
        ...
        do {
            ...
            io:println("Received express shipment request for delivery: " + shipment.toString());
            ...
            io:println(string `Processed express shipment for customer ID: ${shipment.shipmentId}`);
        };
    }
}
